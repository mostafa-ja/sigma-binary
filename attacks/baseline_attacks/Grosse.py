...
def Grosse(
    ...
    # For evasion, the target is the benign class (0)
    ...
    for outer_step in range(outer_iters):
        ...
        for step in range(max_iterations):
            ...
            loss = softmax_scores[torch.arange(batch_size), targets]
            if is_active:
            ...
            # Select the best feature to add by finding the largest positive gradient
        ...
        CONST, upper_bound, lower_bound = update_bounds_and_consts(
            outer_step, binary_search_steps, CONST, upper_bound, lower_bound, prime_success, update_factor=1000.
        )
